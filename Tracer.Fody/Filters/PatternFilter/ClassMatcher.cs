...
{
    public class ClassMatcher : IComparable<ClassMatcher>, IMatcher<TypeDefinition>
    {
        ...
        private ClassMatcher(string regexPattern, bool matchPublic, bool matchNonPublic, string filterExpression, int conditionCount)
        {
