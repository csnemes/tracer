...
$AdapterAssembly = "Tracer.NLog4Net"
$LogManager = "Tracer.NLog4Net.Adapters.LogManagerAdapter"
$Logger = "Tracer.NLog4Net.Adapters.LoggerAdapter"
$StaticLogger = "Tracer.NLog4Net.Log"
